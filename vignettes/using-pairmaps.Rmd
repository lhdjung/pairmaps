...
This is useful if you want to copy and paste the printed output into a script, especially within a package. Always set `eval_f` to `FALSE` if you *call* `as_colpair_mapper()` inside a package. (See below for non-package use cases.)
